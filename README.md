...
Subir todos los archivos y la carpeta `assets/` conservando su estructura. `index.html` es la web pública y `directorio.html` es el directorio interno del Customer Journey.

## Estado

Prototipo sin pagos reales. No habilitar transacciones hasta completar los bloqueantes indicados en `product-constitution.md` y `payment-architecture.md`.
